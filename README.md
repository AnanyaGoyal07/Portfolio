...
| **Real Time Deepfake Video Detection** | To detect deepfake in real time situations. Eg: Virtual Examination | Python, Flask, MySQL | [🔗 View Repo](https://github.com/ShikharGoel2805/Real-Time-Deepfake-Video-Detection.git) |
| **Photo Booth** | A retro versio of the classic Photo Booth with upgraded sticker package and additional features. | JavaScript, CSS, HTML | [🔗 View Repo](https://github.com/AnanyaGoyal07/RetroBooth-.git) |
| **bdms** | A unified Blood Donation Management System for a whole community. | SQL, CSS, HTML | [🔗 View Repo](https://github.com/ShikharGoel2805/bdms.git) |
...
- **LinkedIn:** [Ananya Goyal](https://www.linkedin.com/in/shikhar-goel-254397220)  
